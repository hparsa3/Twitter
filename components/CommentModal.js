    ...
    <div>
      {open && (
        <Modal isOpen={open}
          ...
          className="max-x-lg w-[90%] absolute top-24 left-[50%] translate-x-[-50%] bg-white border-2 border-gray-200 rounded-xl shadow-md">
          <div className="p-1">
            ...
            <span className="w-.5 h-full z-[-1] absolute left-8 top-11 bg-gray-300"/>
